...
class HourlyApiServiceTest {

    private lateinit var apiService: HourlyApiService
    ...
    fun setup() {
        ...
        apiService = Retrofit.Builder()
            ...
            .build()
            .create(HourlyApiService::class.java)
    }
    ...
    fun givenOkLocation_networkResponse200() = runBlocking {
        val lat = 38.2324
        val lon = -0.547
        val result = apiService.findHourlyResponseByLatLon(lat, lon)
    ...
    fun givenWrongLocation_networkResponse400() = runBlocking {
        val latLon = -100.0
        val result = apiService.findHourlyResponseByLatLon(latLon, latLon)
